...
trait OrderAttribute
{
     ...
     * @return string
     */
    public function getRecoverButtonAttribute()
    {
//        print_r($this['id']);exit;
        return '<a href="'.route('admin.order.recover', $this).'"  class="btn btn-xs btn-info"><i class="fa fa-refresh" data-toggle="tooltip" data-placement="top" title="Restore Order"></i></a> ';
