...
<h1>
    ...
    <small>{{ trans('labels.backend.order.create') }}</small>
</h1>
@endsection

@section('content')
{{ Form::open(['route' => 'admin.order.store', 'class' => 'form-horizontal','id'=>'main-cat', 'role' => 'form', 'method' => 'post','files'=>'true']) }}

<div class="box box-success">
    <div class="box-header with-border">
        <h3 class="box-title">{{ trans('labels.backend.order.create') }}</h3>
    ...
    <div class="box-body">
        ...
        <div class="product-list">
            ...
            @foreach(old('product') as $key =>$avail)
            <div class="form-group ">
                ...
                <div class="col-lg-2">
                    {{ Form::number('product['.$key.'][qty]', null, ['class' => 'form-control qty'.$timeIndex, 'min'=>'1', 'required' => 'required','id'=>'qty', 'placeholder' => trans('validation.attributes.backend.order.qty')]) }}
                </div><!--col-lg-3-->
                {{ Form::label('price', trans('validation.attributes.backend.order.price'),
                     ['class' => 'col-lg-2 control-label required']) }}

                <div class="col-lg-2">
                    {{ Form::number('product['.$key.'][price]',null, ['class' => 'form-control price'.$timeIndex, 'min'=>'1', 'required' => 'required','id'=>'price', 'placeholder' => trans('validation.attributes.backend.order.price')]) }}
                </div><!--col-lg-3-->
                <div class="col-lg-1">
