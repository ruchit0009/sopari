...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.product.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'admin.product.store', 'class' => 'form-horizontal','id'=>'main-cat', 'role' => 'form', 'method' => 'post','files'=>'true']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.backend.product.create') }}</h3>
