...
return [
    ...
    */
    ...
    'backend'  => [
        ...
        'welcome'   => <<<'TEXT'
<p>В этой системе управления <strong>"Grocery"</strong>, использована тема оформления <strong>AdminLTE</strong> с минимальным набором стилей и скриптов из этой темы, для полноценной работы этого приложения на данном примере.</p>
